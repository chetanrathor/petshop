    ...
    return (
        <div className="d-flex flex-row">
            <div className="col-5 d-flex flex-row justify-content-center">
                <Image alt='consult_hero' isPublicImage height='592px' width='448px' path='joinVet.png'></Image>
            </div>
            <div className="col-7 p-3">
                <h3 className=' px-5 heading_signup  m-0'> Join As Vet</h3>
                ...
                <div className="px-5 mt-2">
                    ...
                    <ButtonComponent handelClick={() => { handelBookConsultClick() }} backgroundColor='primary' disabled={false} isSubmitButton={false} className='w-100 py-3'>
                        <ButtonText fontSize='medium'>Submit</ButtonText>
                    </ButtonComponent>
                </div>
            </div>
        </div>
