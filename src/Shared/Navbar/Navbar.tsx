                ...
                <div className="d-flex flex-row w-100 navbar__wrapper">
                    <div className="col-5 ">
                        <div className="d-flex flex-row align-items-center justify-content-between logo_brand_container">
                            ...
                            <img src="logo.png" height='48px' width='61px' alt="" />
                                ...
                                return (
                                    <>
                                        <div className="d-flex flex-column align-items-center item">
                                            ...
                                            <img src="Active-dot.png" className='mt-2' height='8px' width='8px' alt="" />
                                        </div>
                                    </>
                                )
                            })
                   ...
                   <button className='btn btn-outline-primary ps-3 pe-4 py-2-5'><img src="cart.png" height='21px' width='30px' alt="" /> <span className='cart_btn_text'>Cart</span> </button>
